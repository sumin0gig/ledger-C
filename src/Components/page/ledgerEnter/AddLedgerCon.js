		...
		<div className='inner'>
			...
			{/* <div className='addStar'>
				...
				<div className='addLeft'>
					...
					<TitleBtnList title={"부채"} color={"debitcolor"} onClick={onchange} name="l_left" value={l_left}/>
				...
				<div className='addRight'>
					...
					<TitleBtnList title={"부채"} color={"debitcolor"} onClick={onchange} name="l_right" value={l_right}/>
